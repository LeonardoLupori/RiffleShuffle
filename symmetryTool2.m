    ...
    methods
        function tool = symmetryTool2(Image,varargin)
            ...
            uicontrol('Parent',tool.Dialog,...
                'Style','popupmenu',...
                'String',{'Left','Right'},...
                'Position', [2*dborder 5*dborder+5*cheight cwidth-dborder cheight],...
                'Callback',@tool.popupManage);
            
            uicontrol('Parent',tool.Dialog,...
                'Style','text',...
                'String','x',...
                'Position',[dborder 4*dborder+4*cheight 20 cheight],...
                'HorizontalAlignment','left');
            tool.SliderX = uicontrol('Parent',tool.Dialog,...
                'Style','slider',...
                'Min',-maxShift,...
                'Max',maxShift,...
                'Value',0,...
                'Position',[2*dborder 4*dborder+4*cheight cwidth-dborder cheight],...
                'Tag','dx');
            addlistener(tool.SliderX,'Value',...
                'PostSet',@tool.continuousSliderManage);
            
            uicontrol('Parent',tool.Dialog,...
                'Style','text',...
                'String','y',...
                'Position',[dborder 3*dborder+3*cheight 20 cheight],...
                'HorizontalAlignment','left');
            tool.SliderY = uicontrol('Parent',tool.Dialog,...
                'Style','slider',...
                'Min',-maxShift,...
                'Max',maxShift,...
                'Value',0,...
                'Position',[2*dborder 3*dborder+3*cheight cwidth-dborder cheight],...
                'Tag','dy');
            ...
            uicontrol('Parent',tool.Dialog,...
                'Style','text',...
                'String','a',...
                'Position',[dborder 2*dborder+2*cheight 20 cheight],...
                'HorizontalAlignment','left');
            tool.SliderA = uicontrol('Parent',tool.Dialog,...
                'Style','slider',...
                'Min',-maxAngle,...
                'Max',maxAngle,...
                'Value',0,...
                'Position',[2*dborder 2*dborder+2*cheight cwidth-dborder cheight],...
                'Tag','da');
            ...
            uicontrol('Parent',tool.Dialog,...
                'Style','pushbutton',...
                'String','Done',...
                'Position',[dborder dborder cwidth 2*cheight],...
                'Callback',@tool.buttonDonePushed);
