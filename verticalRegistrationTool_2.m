classdef verticalRegistrationTool_2 < handle
    properties
        FigureImages
        AxisImage
        HandleImage
    ...
    methods
        function tool = verticalRegistrationTool_2(Moving,Fixed,varargin)
            tool.Image{1} = Moving;
            tool.Image{2} = Fixed;
            ...
            tool.FigureImages = figure('Position',[ss(3)/4 ss(4)/4 ss(3)/2 ss(4)/2],...
                'NumberTitle','off',...
                'Name','Vertical Registration Tool',...
                'CloseRequestFcn',@tool.closeFigure, 'Resize','on');
